...
public class SoundtrackToLife {
	...
	public static void main(String[] args) {
		...
		// 2. Theiratch?v=nZamwCZOWHI answer is stored in the userMood variable. Print it out.

		// 3. If they are in a stressed mood, use the playVideo method to play a calming song from YouTube.
		String youtube ="https://www.youtube.com/watch?v=nZamwCZOWHI";
        ...
        String happy = "http://bit.ly/video-for-happy";
